"""Shared DIRECT daemon with durable, route-independent Telegram delivery."""
...
def __getattr__(name: str):
    if name in {"service_settings", "main"}:
        from litechecker import macos_service
        return getattr(macos_service, name)
    raise AttributeError(name)


if __name__ == "__main__":
    from litechecker.macos_service import main
